...
# trivialWall loss
_C.TRAIN.CRITERION.TRIVIALWALLS = CN()
_C.TRAIN.CRITERION.TRIVIALWALLS.NAME = 'trivialWalls'
_C.TRAIN.CRITERION.TRIVIALWALLS.LOSS = 'L1Loss'
_C.TRAIN.CRITERION.TRIVIALWALLS.WEIGHT = 0.0
_C.TRAIN.CRITERION.TRIVIALWALLS.WEIGHTS = []
_C.TRAIN.CRITERION.TRIVIALWALLS.NEED_ALL = False
