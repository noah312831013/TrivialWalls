...
```shell
python inference.py --cfg src/config/zind.yaml --img_glob demo_data/inference_data_format/color.jpg --corners_glob demo_data/inference_data_format/GT.txt --output_dir src/output --post_processing manhattan
```
